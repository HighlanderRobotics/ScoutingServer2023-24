        ...
        tasks.forEach(async (task) => {
            ...
            switch (task.name) {
                ...
                case("matchPrediction"):
                    returnAnalysis.push(new matchPrediction(task.red1, task.red2, task.red3, task.blue1, task.blue2, task.blue3, task.tournamentSettings, task.teamScoutedSettings))
                    break
                // case ("picklist"):
