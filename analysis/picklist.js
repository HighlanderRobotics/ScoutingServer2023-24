...
var picklist = /** @class */ (function (_super) {
    ...
    function picklist(team, coneOneScore, coneTwoScore, coneThreeScore, cubeOneScore, cubeTwoScore, cubeThreeScore, autoCargo, teleOp, defense, climbAuto, feedCone, feedCube, avgTotal, teleopClimb, driverAbility, allAndArray) {
    ...
    picklist.prototype.getData = function () {
        throw new Error('Method not implemented.');
    };
    picklist.prototype.runAnalysis = function () {
    ...
    picklist.prototype.finalizeResults = function () {
        return {};
    };
    return picklist;
