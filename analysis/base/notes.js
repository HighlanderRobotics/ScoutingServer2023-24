...
var notes = /** @class */ (function (_super) {
    ...
    function notes(team, teamsScoutedSettings, tournamentScoutedSettings) {
    ...
    notes.prototype.runAnalysis = function () {
        var _this = this;
        var a = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, a.getNotes().catch(function (err) {
                            reject(err);
                        })];
                    case 1:
                        _a.sent();
    ...
    notes.prototype.finalizeResults = function () {
        return {
            "team": this.team,
            "notes": this.notes
        };
